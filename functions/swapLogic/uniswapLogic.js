...
async function uniswapHotSwap(recipientAddress, amount, swapCurrency) {
    ...
    return exchangeContract.functions.ethToTokenTransferInput(ethers.utils.hexlify(1), ethers.utils.hexlify(2552132999), recipientAddress, {value: ethers.utils.parseEther(amount), gasLimit: 100000})
      .then(tx => tx)
      .catch(err => err);
}
